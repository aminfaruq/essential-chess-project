        ...
        UIView.performWithoutAnimation {
            ...
            for rank in 1...8 {
                for file in ["a", "b", "c", "d", "e", "f", "g", "h"] {
                    ...
                    if let alternative = alternativePieceImage(for: piece, at: squareString) {
                        image = alternative.image
                        inset = alternative.inset
                        isAlternative = true
                    } else {
                        image = UIImage(named: "\(currentPieceTheme)_\(colorLetter)\(pieceLetter)")
                        inset = 4
                        isAlternative = false
                    }
